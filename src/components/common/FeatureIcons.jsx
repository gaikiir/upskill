        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-12">
          {icons.map((icon, index) => (
            <div
              key={index}
              // hover:bg-gray-50
              className="flex flex-col items-center justify-center gap-4 p-6 rounded-none  transition-colors duration-200"
            >
              {/* hover:text-gray-900 */}
              <div className="text-gray-100  transition-colors">{icon.svg}</div>
